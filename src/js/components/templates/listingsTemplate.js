export function listingsHTML(
  ...
  const html = `
  <div class="listing-card mb-5  border p-2 rounded-sm">
          ...
          <div class="listing-info">
            ...
            <p class="font-mainfont text-inactiveTextLight text-xs -mt-3 dark:text-inactiveTextDark">Sold by ${listingSeller}</p>
              ...
              <div class="flex justify-between">
                <div class="end-date font-mainFont flex justify-end mr-4">
                  ${date}
                </div>
                <div class="end-time font-mainFont flex justify-end">
                  ${time}
              </div>
            
          
          </div>
          <hr class="w-full mb-5 mt-2">
